class MircopostsController < ApplicationController
  ...
  def create
    ...
    @mircopost.thumb = uploadfile params[:mircopost][:thumb]
    @mircopost.user = current_user
    @mircopost.followers = 0
    #debugger
  ...
  private
    ...
    def mircopost_params
      params.require(:mircopost).permit(:content, :thumb)
    end
end
